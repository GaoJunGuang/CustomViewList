...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_main = (ListView) findViewById(R.id.lv_person);
    ...
    private void initData() {
        ...
        persons.add(new Person("杨龙疯"));
        persons.add(new Person("Jagger"));
        persons.add(new Person("蔡俊杰"));
        persons.add(new Person("黄萍"));
        persons.add(new Person("张长飞"));
        persons.add(new Person("黄萍"));
        persons.add(new Person("黄海洋"));
        persons.add(new Person("王立成"));
        persons.add(new Person("冯臻林"));
