...
public class TopBarLayout extends RelativeLayout {
    ...
    public TopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLeftTextColor = ta.getColor(
                R.styleable.TopBarLayout_leftTextColor, 0);
        mLeftBackground = ta.getDrawable(
                R.styleable.TopBarLayout_leftBackground);
        mLeftText = ta.getString(R.styleable.TopBarLayout_leftText);

        mRightTextColor = ta.getColor(
                R.styleable.TopBarLayout_rightTextColor, 0);
        mRightBackground = ta.getDrawable(
                R.styleable.TopBarLayout_rightBackground);
        mRightText = ta.getString(R.styleable.TopBarLayout_rightText);

        mTitleTextSize = ta.getDimension(
                R.styleable.TopBarLayout_centerTitleTextSize, 20);
        mTitleTextColor = ta.getColor(
                R.styleable.TopBarLayout_centerTitleTextColor, 0);
        mTitle = ta.getString(R.styleable.TopBarLayout_centerTitle);
...
//        mRightButton.setBackground(mRightBackground);//api16以上才能使用
